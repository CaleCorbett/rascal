...
enum ActionRegistry {
    ...
    static let all: [Action] = [
        ...
        .init(id: "edit.cut",
              ...
              category: .edit,
              icon: "scissors",
              defaultShortcut: KeyShortcut("x", [.command])) { $0.cutFiles(nil) },
        .init(id: "edit.paste",
              title: "Paste",
              category: .edit,
              icon: "doc.on.clipboard",
        ...
        .init(id: "pane.add",
              ...
              category: .panes,
              icon: "rectangle.split.3x1",
              defaultShortcut: KeyShortcut("\\", [.command, .control])) { $0.addPane(nil) },
        .init(id: "pane.close",
              title: "Close Pane",
              category: .panes,
              icon: "minus.rectangle",
              defaultShortcut: nil) { $0.closeActivePane(nil) },
